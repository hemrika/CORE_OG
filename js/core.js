...
// Elementary. A CSS workflow for mimicking element queries.
// [c]2014 @scottjehl, @filamentgroup. MIT license.
(function(a){a.elementary=function(l){if(!("querySelector" in a.document)||!("getComputedStyle" in a)){return}var e=l&&l.selector||".cq";var k=a.document.querySelectorAll(e);for(var c=0;c<k.length;c++){var j=k[c],g=a.getComputedStyle(j,":before").getPropertyValue("content"),d=g.replace(/[^\d ]/g,"").split(" "),b=j.clientWidth,h=[];for(var f=0;f<d.length;f++){if(a.parseFloat(d[f])<=b){h.push(d[f])}}j.setAttribute("data-minwidth",h.join(" "))}}})(this);
...
// Bootstrap "Collapse"
// Generated using the Bootstrap Customizer http://getbootstrap.com/customize/?id=a57cdb70eeecccfa70b2
...
$(document).ready(function() {
  ...
  $('.full-width-slider .gallery').flickity({
    // options
  	...
  	// Content Post Slider
  	$('.content-post-slider .gallery').flickity({
    // options
  	  autoPlay: 8500,
  	  arrowShape: { 
        x0: 10,
  	...
  	// Promo Slider
  	var $gallery = $('.promo-slider .gallery').flickity({
    	//autoPlay: true,
    	pageDots: false,
      initialIndex: 1,
      wrapAround: true
    ...
    // Tab Slider
    var $gallery = $('.tab-slider .gallery').flickity({
      lazyLoad: true,
      pageDots: false,
    ...
    $('.gallery').addClass('flickity-loaded');
   ...
   // Show/Hide Panel on calendar list
  $('.show-panel').click(function() {
    $(this).parent().parent().toggleClass('panel-open');
    //$(this).parent().find('.panel-content').attr( 'aria-hidden', 'false' );
     
  });
  
  // Media Viewer Toggle Buttons
    
  // Audio Media
  $('.media-toggle-audio').click(function() {
    $(this).parent().parent().toggleClass('audio-media-open');
    $(this).parent().parent().removeClass('video-media-open');
    $(this).parent().parent().removeClass('photo-media-open');
  });
  
  // Video Media
  $('.media-toggle-video').click(function() {
    $(this).parent().parent().toggleClass('video-media-open');
    $(this).parent().parent().removeClass('audio-media-open');
    $(this).parent().parent().removeClass('photo-media-open');
  });
  
  // Photo Media
  $('.media-toggle-photos').click(function() {
    $(this).parent().parent().toggleClass('photo-media-open');
    $(this).parent().parent().removeClass('audio-media-open');
    $(this).parent().parent().removeClass('video-media-open');
  });
